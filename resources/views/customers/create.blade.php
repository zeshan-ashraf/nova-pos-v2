                    ...
                    @csrf
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" step="0.01" min="0" class="form-control @error('credit_limit') is-invalid @enderror" id="credit_limit" name="credit_limit" value="{{ old('credit_limit', 0) }}" required>
                                @error('credit_limit')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" min="0" class="form-control @error('credit_days') is-invalid @enderror" id="credit_days" name="credit_days" value="{{ old('credit_days', 0) }}" required>
                                @error('credit_days')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
