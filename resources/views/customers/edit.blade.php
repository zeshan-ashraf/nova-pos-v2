                ...
                <div class="card-body">
                    ...
                    @method('put')
                        ...
                        <div class=" row align-items-center">
                            {{-- Customer Name field removed from UI - may be needed in future --}}
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" step="0.01" min="0" class="form-control @error('credit_limit') is-invalid @enderror" id="credit_limit" name="credit_limit" value="{{ old('credit_limit', $customer->credit_limit ?? 0) }}" required>
                                @error('credit_limit')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" step="0.01" min="0" class="form-control @error('credit_amount') is-invalid @enderror" id="credit_amount" name="credit_amount" value="{{ old('credit_amount', $customer->credit_amount ?? 0) }}" readonly disabled>
                                @error('credit_amount')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" min="0" class="form-control @error('credit_days') is-invalid @enderror" id="credit_days" name="credit_days" value="{{ old('credit_days', $customer->credit_days ?? 0) }}" required>
                                @error('credit_days')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" step="0.01" class="form-control @error('opening_balance') is-invalid @enderror" id="opening_balance" name="opening_balance" value="{{ old('opening_balance', $customer->opening_balance ?? 0) }}" placeholder="0 = none; positive = customer owes; negative = advance">
                                @error('opening_balance')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                                @enderror
                                <small class="text-muted">Positive = customer owes you. Negative = advance. Credit Amount is synced from ledger.</small>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="opening_balance_date">Opening Balance Date</label>
                                <input type="datetime-local" class="form-control @error('opening_balance_date') is-invalid @enderror" id="opening_balance_date" name="opening_balance_date" value="{{ old('opening_balance_date', $customer->opening_balance_date ? $customer->opening_balance_date->format('Y-m-d\TH:i') : '') }}">
