...
<body>
    ...
    <div class="supplier-info">
        <p><strong>Supplier:</strong> {{ $supplier->shopname }}</p>
    ...
    <div class="summary">
        ...
        <div class="summary-row">
            ...
            <span>{{ $summary['total_purchases'] }}</span>
        </div>
        <div class="summary-row">
            <span>Total Purchase Amount:</span>
            <span>{{ number_format($summary['total_purchase_amount'], 2) }}</span>
        </div>
        <div class="summary-row">
        ...
        <tbody>
            @forelse ($transactions as $transaction)
                <tr>
                    ...
                    <td>{{ $transaction['purchase_no'] ?? ('Purchase #' . $transaction['purchase_id']) }}</td>
