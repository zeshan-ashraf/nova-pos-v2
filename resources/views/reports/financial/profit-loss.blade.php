        ...
        <div class="col-lg-12">
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0 text-muted">Profit = Revenue − COGS − Expenses. Opening balance does not affect profit.</p>
                </div>
                <div>
        ...
        <div class="col-lg-12 mb-3">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <p class="text-muted mb-1">COGS</p>
                            <h4 class="mb-0">{{ number_format($cogs ?? 0, 2) }}</h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="mb-0">{{ number_format($grossProfit ?? 0, 2) }}</h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="mb-0 {{ ($netProfit ?? 0) >= 0 ? 'text-success' : 'text-danger' }}">{{ number_format($netProfit ?? 0, 2) }}</h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="mb-0">{{ number_format($profitMargin ?? 0, 2) }}%</h4>
                        </div>
                    </div>
                </div>
            </div>
