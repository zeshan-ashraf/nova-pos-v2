...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0 text-muted">Money spent by the business (from expenses table).</p>
                </div>
                <div>
        ...
        <div class="col-lg-12 mb-3">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('reports.financial.expense') }}" method="GET">
        ...
        <div class="col-lg-12 mb-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="mb-0">{{ number_format($totalExpenses ?? 0, 2) }}</h4>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12 mb-3">
            <div class="card">
                <div class="card-header"><h5 class="mb-0">Expenses by Date</h5></div>
                <div class="card-body">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header"><h5 class="mb-0">Expenses by Category (Title)</h5></div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <thead>
