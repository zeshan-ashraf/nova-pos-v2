...
<style>
    @media print {
        ...
        /* KPI Row 1: 4 boxes in one row (Total Orders, Revenue, Paid, Due) */
        ...
        .sales-kpi-row-1 .col-md-3 .sales-report-kpi { break-inside: avoid; }
        /* KPI Row 2: 3 boxes in one row (Labour, Discount, Avg Order Value) */
        .sales-kpi-row-2 { display: flex !important; flex-wrap: nowrap !important; break-inside: avoid; }
        .sales-kpi-row-2 .col-md-4 { flex: 0 0 33.333333% !important; max-width: 33.333333% !important; padding: 0 6px !important; }
        .sales-kpi-row-2 .col-md-4 .sales-report-kpi { break-inside: avoid; }
        /* KPI cards: force visible borders and backgrounds in print */
        .sales-report-kpi, .sales-report-kpi.card {
            border: 1px solid #dee2e6 !important;
            box-shadow: none !important;
            -webkit-print-color-adjust: exact;
            print-color-adjust: exact;
        }
        .sales-report-kpi .card-body { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        .sales-report-kpi .iq-icon-box-2 { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        /* Orders table card */
        .card { border: 1px solid #dee2e6 !important; box-shadow: none !important; }
        .card-header.bg-primary { background: #0d6efd !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        /* Hide row selector and pagination in print */
        .card-header .form-control, .card-header form { display: none !important; }
        .card-body > .mt-3 { display: none !important; }
        /* Table full width - full-bleed + explicit column widths like supplier ledger */
        ...
        #salesOrdersTable { width: 100% !important; min-width: 100% !important; max-width: 100% !important; table-layout: fixed !important; box-sizing: border-box !important; }
        #salesOrdersTable th, #salesOrdersTable td { border: 1px solid #dee2e6 !important; box-sizing: border-box !important; }
        #salesOrdersTable th:nth-child(1), #salesOrdersTable td:nth-child(1) { width: 5% !important; }
        #salesOrdersTable th:nth-child(2), #salesOrdersTable td:nth-child(2) { width: 10% !important; }
        #salesOrdersTable th:nth-child(3), #salesOrdersTable td:nth-child(3) { width: 18% !important; }
        #salesOrdersTable th:nth-child(4), #salesOrdersTable td:nth-child(4) { width: 10% !important; }
        #salesOrdersTable th:nth-child(5), #salesOrdersTable td:nth-child(5) { width: 10% !important; }
        #salesOrdersTable th:nth-child(6), #salesOrdersTable td:nth-child(6) { width: 10% !important; }
        #salesOrdersTable th:nth-child(7), #salesOrdersTable td:nth-child(7) { width: 10% !important; }
        #salesOrdersTable th:nth-child(8), #salesOrdersTable td:nth-child(8) { width: 14% !important; }
        #salesOrdersTable th:nth-child(9), #salesOrdersTable td:nth-child(9) { width: 13% !important; }
        /* Badges in print */
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-12 mb-3 d-print-none">
            <div class="card report-filter-card border-primary shadow-sm">
                ...
                <div class="card-body pt-0">
                    <form action="{{ route('reports.sales.summary') }}" method="GET" id="filterForm">
        ...
        <!-- KPI Cards Row 1: Total Orders, Revenue, Paid, Due -->
        ...
        <!-- KPI Cards Row 2: Labour, Discount, Avg Order Value -->
        <div class="col-lg-12 mb-3">
                ...
                <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card card-block card-stretch card-height shadow-sm sales-report-kpi summary-kpi-card card-secondary h-100">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 min-w-0">
                                <p class="text-muted mb-0 small font-weight-500">Total Labour Charges</p>
                                <h5 class="mb-0 font-weight-bold text-dark">{{ number_format($totalVat, 2) }}</h5>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card card-block card-stretch card-height shadow-sm sales-report-kpi summary-kpi-card card-warning h-100">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 min-w-0">
                                <p class="text-muted mb-0 small font-weight-500">Total Discount</p>
                                <h5 class="mb-0 font-weight-bold text-dark">{{ number_format($totalDiscount, 2) }}</h5>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card card-block card-stretch card-height shadow-sm sales-report-kpi summary-kpi-card card-dark h-100">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 min-w-0">
                                <p class="text-muted mb-0 small font-weight-500">Average Order Value</p>
                                <h5 class="mb-0 font-weight-bold text-dark">{{ number_format($avgOrderValue, 2) }}</h5>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-12 sales-orders-table-wrap">
            <div class="card">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <form action="{{ route('reports.sales.summary') }}" method="GET" class="d-inline">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped" id="salesOrdersTable">
                            <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Invoice No</th>
