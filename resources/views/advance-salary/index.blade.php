    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <a href="{{ route('advance-salary.index') }}" class="btn btn-danger add-list"><i class="las la-trash mr-3"></i>Clear Search</a>
                </div>
            </div>
        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group flex-nowrap">
                                <input type="text" id="search" class="form-control" name="search" placeholder="Search employee" value="{{ request('search') }}" style="min-width: 200px;">
        ...
        <div class="col-lg-12">
            <div class="table-responsive rounded mb-3">
                <table class="table mb-0">
                    ...
                    <tbody class="ligth-body">
                        ...
                        <tr>
                            <td>{{ (($advance_salaries->currentPage() * $advance_salaries->perPage()) - $advance_salaries->perPage()) + $loop->iteration  }}</td>
                            <td>
            ...
            {{ $advance_salaries->appends(request()->query())->links() }}
        </div>
    </div>
    <!-- Page end  -->
</div>
