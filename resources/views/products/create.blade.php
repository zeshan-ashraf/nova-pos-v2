                    ...
                    @csrf
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control @error('low_stock_warning') is-invalid @enderror" id="low_stock_warning" name="low_stock_warning" value="{{ old('low_stock_warning', 10) }}" min="0">
