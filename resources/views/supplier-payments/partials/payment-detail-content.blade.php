{{-- Payment detail content: used by supplier ledger modal. --}}
@php
...
<div class="payment-detail-content">
    <div class="border rounded p-3 mb-3" style="background-color: #f8f9fa;">
        ...
        <div class="row mt-2">
            <div class="col-md-6">
                <div class="mb-2"><strong>Supplier</strong></div>
                <div class="readonly-field">{{ $supplier ? ($supplier->shopname ?? $supplier->name ?? '—') : '—' }}</div>
            </div>
            <div class="col-md-6">
    ...
    <div class="d-flex flex-wrap gap-2">
        <a href="{{ route('supplier-payments.create') }}" class="btn btn-outline-primary btn-sm">View all payments</a>
