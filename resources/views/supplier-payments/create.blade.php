        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Record Supplier Payment</h4>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('supplier-payments.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <select class="form-control supplier-select @error('supplier_id') is-invalid @enderror" id="supplier_id" name="supplier_id" required>
                                    <option value="">Select supplier</option>
                                    @foreach($suppliers ?? [] as $s)
                                        <option value="{{ $s->id }}" {{ old('supplier_id', request('supplier_id')) == $s->id ? 'selected' : '' }}>{{ $s->shopname ?: $s->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('description') is-invalid @enderror" id="description" name="description" value="{{ old('description') }}" placeholder="e.g. Payment for purchase PUR-XXX">
            ...
            <div class="card mt-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <form method="get" action="{{ route('supplier-payments.create') }}" class="d-flex align-items-center">
