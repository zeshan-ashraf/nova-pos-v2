    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                <a href="{{ route('employees.create') }}" class="btn btn-primary add-list"><i class="fas fa-plus mr-3"></i>Add Employee</a>
                <a href="{{ route('employees.index') }}" class="btn btn-danger add-list"><i class="las la-trash mr-3"></i>Clear Search</a>
                </div>
            </div>
        </div>
